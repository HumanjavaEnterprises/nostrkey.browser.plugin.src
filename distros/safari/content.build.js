(() => {
  ...
  api.runtime.onMessage.addListener((message, sender, sendResponse) => {
    if (message.kind === "showPermissionSheet") {
      Promise.resolve().then(() => showPermissionSheet(message.host, message.permissionKind, message.queuePosition, message.queueTotal)).then((result) => sendResponse(result)).catch(() => sendResponse(null));
      return true;
    }
